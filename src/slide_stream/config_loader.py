...
providers:
  llm:
    ...
    # base_url: http://localhost:11434   # ollama / openai-compatible servers
    # api_key: "${OLLAMA_TOKEN}"        # Bearer token for an authenticated proxy
    # think: false                      # reasoning models: strip/disable thinking
    # API keys come from the environment: OPENAI_API_KEY, ANTHROPIC_API_KEY,
    # GEMINI_API_KEY, GROQ_API_KEY, OLLAMA_TOKEN. Narration uses speaker notes as the
